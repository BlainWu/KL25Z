...
void pwmled_init(){
	...
	PORTD_PCR1 |= PORT_PCR_MUX(4);	//set PORTD1 I/O as TPM0_CH0
	PORTB_PCR18 |=PORT_PCR_MUX(3);	//set PORTB18 I/0 as TPM2_CH0
	PORTB_PCR19 |=PORT_PCR_MUX(3);	//set PORTB19 I/0 as TPM2_CH1
